...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://dosityna.com/wp-content/uploads/2021/09/nghe-thuat-trinh-bay-va-chup-anh-mon-an-8.jpg" alt="Los Angeles">
    </div>
    <div class="carousel-item">
      <img src="https://images.foody.vn/images/cidre-3-2048-1459002815059-234-0-1136-2048-crop-1459002866249.jpg" alt="Chicago">
    </div>
    <div class="carousel-item">
      <img src="https://media.cooky.vn/images/blog-2016/nghe-thuat-trinh-bay-va-chup-anh-mon-an%201.jpg" alt="New York">
    </div>
  </div>
...
<!-- banner stop -->
<div class="container">
	<h1 style="text-align: center; margin-top: 20px; margin-bottom: 20px;">ĐỒ ĂN MỚI</h1>
	<div class="row">
	<?php
